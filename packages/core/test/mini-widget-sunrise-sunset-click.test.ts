/**
 * Tests for CalendarMiniWidget sunrise/sunset click functionality
 *
 * Clicking sunrise/sunset should set the time to sunrise/sunset on the CURRENT day,
...
describe('CalendarMiniWidget - Sunrise/Sunset Click Functionality', () => {
  ...
  describe('Edge cases', () => {
    it('should preserve year, month, and day when setting time', async () => {
      await manager.setCurrentDate(
        new CalendarDate(
